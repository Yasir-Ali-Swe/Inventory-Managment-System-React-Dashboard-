...
const EditCategory = ({ category, onBackToCategories }) => {
    ...
    return (
      <div className='h-full w-full px-2'>
        <div className='CategoriesHeader py-11 bg-secondary'>
          <h1 className='text-2xl text-textColor font-bold'>No Category Selected</h1>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className='h-full w-full px-2'>
      <div className='CategoriesHeader py-11 bg-secondary'>
        <h1 className='text-2xl text-textColor font-bold hover:text-tertiary cursor-pointer'>Edit Category</h1>
      </div>
